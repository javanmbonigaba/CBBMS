...
urlpatterns = [
    ...
    path('', views.home_view, name='home'),  # Added name='home'
    path('logout', LogoutView.as_view(template_name='blood/logout.html'), name='logout'),
    path('afterlogin', views.afterlogin_view, name='afterlogin'),
    # Updated to use the correct template for admin login
    path('adminlogin', LoginView.as_view(template_name='blood/adminlogin.html'), name='adminlogin'),
    # User login
    path('userlogin', LoginView.as_view(template_name='users/user_login.html'), name='userlogin'),
    ...
    path('admin-event', views.create_event, name='admin_event'),
    path('admin-event-view', views.admin_event_view, name='admin-event-view'),
